...
describe('EmailIt Edge Dispatch & Executive Response Ingestion', () => {
  ...
  it('should process valid executive response approvals successfully', async () => {
    vi.mocked(fetch).mockResolvedValueOnce({
      status: 200,
      text: async () => 'DIRECTIVE INGESTED SUCCESSFULLY'
    });
