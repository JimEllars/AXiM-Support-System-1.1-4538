        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 backdrop-blur-xl bg-black/80">
          ...
          >
            ...
            <div className="p-10 space-y-8">
              ...
              <button className="w-full py-5 bg-amber-600 hover:bg-amber-500 text-black font-black uppercase tracking-[0.2em] rounded-2xl transition-all shadow-[0_0_30px_rgba(245,158,11,0.3)]">
                Push Global Broadcast
              </button>
            </div>
          </motion.div>
        </div>
