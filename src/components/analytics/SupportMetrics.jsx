...
export default function SupportMetrics() {
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 font-mono">
      ...
      {/* Pending Executive Inputs Card */}
      <div className="p-4 rounded-2xl bg-zinc-950/60 border border-zinc-800/80 backdrop-blur-md flex items-center justify-between">
        <div>
          <span className="text-[10px] text-zinc-500 font-bold uppercase tracking-wider">Pending Exec Input</span>
          <div className="text-xl font-bold text-amber-400 mt-1">{metrics.pendingExecutiveInputs}</div>
        </div>
