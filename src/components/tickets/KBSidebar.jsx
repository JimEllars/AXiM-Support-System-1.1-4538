...
const { FiCpu, FiExternalLink, FiTarget } = FiIcons;

export default function KBSidebar({ subject, description }) {
      ...
      <div className="space-y-4">
        {loading ? (
          ...
          suggestions.map((item) => (
            <div key={item.id} className="group p-5 bg-zinc-950/50 hover:bg-fuchsia-500/5 rounded-2xl border border-zinc-800 hover:border-fuchsia-500/40 transition-all cursor-pointer">
